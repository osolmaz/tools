...
- `skills/data-model/`
  Use this when creating JSON schemas, API payloads, SQL tables, migrations, or
  other structured data models so each field or column is scrutinized before the
  minimum viable schema is finalized.
