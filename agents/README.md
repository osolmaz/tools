...
- `skills/write-readme/`
  Use this when creating, rewriting, or reviewing README files so they stay focused on what users need: what the project is, how to install it, how to use it, and where deeper docs live.
