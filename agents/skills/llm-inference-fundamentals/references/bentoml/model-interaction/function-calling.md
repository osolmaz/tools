...
- Structured outputs: You decide the [format that the model uses in its responses](structured-outputs.md). For example, you can force the model to output JSON, a list, or a specific object.
