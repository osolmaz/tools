...
If you want the lower-level GPU context behind ideas like HBM, SRAM, warps, and tiling, see [GPU architecture fundamentals](gpu-architecture-fundamentals.md).
...
For a broader view of where Triton, CUDA, compiler stacks, and profiling tools fit into this kind of work, see [Kernel optimization tools](kernel-optimization-tools.md).
