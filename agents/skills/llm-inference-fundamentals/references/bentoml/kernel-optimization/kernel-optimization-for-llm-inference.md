...
It’s easy to mix it up with other optimization techniques covered in the [Inference Optimization](../inference-optimization/index.md) chapter. Kernel optimization is not:
