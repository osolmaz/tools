...
Therefore, inference routing is closely tied to concepts like [prefix caching](prefix-caching.md), [KV cache offloading](kv-cache-offloading.md), and [prefill-decode disaggregation](prefill-decode-disaggregation.md).
