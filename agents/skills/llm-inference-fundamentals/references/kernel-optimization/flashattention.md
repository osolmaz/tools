...
[Inference Optimization](../inference-optimization/index.md).
:::
...
tiling, see
[GPU architecture fundamentals](gpu-architecture-fundamentals.md).
...
<figure>
![FlashAttention tiling diagram](https://raw.githubusercontent.com/modular/llm-inference-handbook/317b9816ec3080031333ed9ee44dfce919763bf7/docs/kernel-optimization/img/flashattention-diagram.png)
  <figcaption>
...
[Kernel optimization tools](kernel-optimization-tools.md).
